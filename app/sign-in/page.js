        ...
        <div className="w-full max-w-md">
          ...
          <div className="mt-10 space-y-3">
            ...
            <div className="flex items-start space-x-3 p-3 bg-green-50 rounded-lg border border-green-200">
              ...
              <div>
                <p className="text-sm font-medium text-green-900">Instant Access</p>
                <p className="text-xs text-green-700 mt-0.5">Book appointments and manage your health</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3 p-3 bg-purple-50 rounded-lg border border-purple-200">
              ...
              <div>
                ...
                <p className="text-xs text-purple-700 mt-0.5">Our support team is always here to help</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                Welcome to MediCare Hospital, where we provide world-class healthcare services with a team of expert doctors and modern facilities.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-white rounded-xl p-4 shadow-md border border-gray-100">
                ...
                <p className="font-semibold text-gray-900 text-sm">500+ Doctors</p>
                <p className="text-xs text-gray-600 mt-1">Expert specialists</p>
              </div>

              <div className="bg-white rounded-xl p-4 shadow-md border border-gray-100">
                <div className="text-3xl mb-2">🏥</div>
                <p className="font-semibold text-gray-900 text-sm">25+ Departments</p>
                <p className="text-xs text-gray-600 mt-1">Comprehensive services</p>
              </div>

              <div className="bg-white rounded-xl p-4 shadow-md border border-gray-100">
                <div className="text-3xl mb-2">👩‍⚕️</div>
                <p className="font-semibold text-gray-900 text-sm">200+ Nurses</p>
                <p className="text-xs text-gray-600 mt-1">24/7 care</p>
              </div>

              <div className="bg-white rounded-xl p-4 shadow-md border border-gray-100">
                <div className="text-3xl mb-2">💊</div>
                <p className="font-semibold text-gray-900 text-sm">5000+ Medicines</p>
                <p className="text-xs text-gray-600 mt-1">Full pharmacy</p>
              </div>
            </div>
          </div>
        </div>
