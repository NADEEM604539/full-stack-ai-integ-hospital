  ...
  return (
    <div style={{ padding: '2rem' }}>
      <div style={{ marginBottom: '2rem' }}>
        <h1 style={{ margin: '0 0 0.5rem 0' }}>All Patients</h1>
        <p style={{ margin: 0, color: '#666' }}>View and manage hospital patients</p>
      </div>
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
          <thead>
            <tr style={{ backgroundColor: '#f5f5f5', borderBottom: '2px solid #ddd' }}>
              ...
              <th style={{ padding: '1rem', textAlign: 'left', fontWeight: 'bold' }}>DOB</th>
            ...
            {filteredPatients.map(patient => (
              <tr key={patient.patient_id} style={{ borderBottom: '1px solid #eee' }}>
                <td style={{ padding: '1rem' }}>
                  ...
                  <div style={{ fontSize: '0.85rem', color: '#666' }}>{patient.email || '-'}</div>
                </td>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '1rem', marginBottom: '2rem' }}>
              <div>
                <label style={{ fontWeight: 'bold', color: '#666', fontSize: '0.9rem' }}>First Name</label>
                <div>{selectedPatient.first_name}</div>
              </div>
              <div>
                <label style={{ fontWeight: 'bold', color: '#666', fontSize: '0.9rem' }}>Last Name</label>
                <div>{selectedPatient.last_name}</div>
              </div>
              <div>
                <label style={{ fontWeight: 'bold', color: '#666', fontSize: '0.9rem' }}>MRN</label>
                <div>{selectedPatient.mrn}</div>
              </div>
              <div>
                <label style={{ fontWeight: 'bold', color: '#666', fontSize: '0.9rem' }}>Date of Birth</label>
                <div>{selectedPatient.date_of_birth ? new Date(selectedPatient.date_of_birth).toLocaleDateString() : '-'}</div>
              </div>
              <div>
                <label style={{ fontWeight: 'bold', color: '#666', fontSize: '0.9rem' }}>Gender</label>
                <div>{selectedPatient.gender || '-'}</div>
              </div>
              <div>
                <label style={{ fontWeight: 'bold', color: '#666', fontSize: '0.9rem' }}>Blood Type</label>
                <div>{selectedPatient.blood_type || '-'}</div>
              </div>
              <div>
                <label style={{ fontWeight: 'bold', color: '#666', fontSize: '0.9rem' }}>Phone</label>
                <div>{selectedPatient.phone_number || '-'}</div>
              </div>
              <div>
                <label style={{ fontWeight: 'bold', color: '#666', fontSize: '0.9rem' }}>Email</label>
                <div>{selectedPatient.email || '-'}</div>
              </div>
              <div style={{ gridColumn: 'span 2' }}>
                <label style={{ fontWeight: 'bold', color: '#666', fontSize: '0.9rem' }}>Address</label>
                <div>{selectedPatient.address || '-'}</div>
              </div>
              <div>
                <label style={{ fontWeight: 'bold', color: '#666', fontSize: '0.9rem' }}>City</label>
                <div>{selectedPatient.city || '-'}</div>
              </div>
              <div>
                <label style={{ fontWeight: 'bold', color: '#666', fontSize: '0.9rem' }}>Department</label>
                <div>{selectedPatient.department_name || '-'}</div>
              </div>
              <div>
                <label style={{ fontWeight: 'bold', color: '#666', fontSize: '0.9rem' }}>Emergency Contact</label>
                <div>{selectedPatient.emergency_contact || '-'}</div>
              </div>
              <div>
                <label style={{ fontWeight: 'bold', color: '#666', fontSize: '0.9rem' }}>Emergency Phone</label>
                <div>{selectedPatient.emergency_phone || '-'}</div>
              </div>
              <div>
                <label style={{ fontWeight: 'bold', color: '#666', fontSize: '0.9rem' }}>AI Readmission Risk</label>
                <div>{selectedPatient.ai_readmission_risk ? `${selectedPatient.ai_readmission_risk}%` : 'N/A'}</div>
              </div>
            </div>
            <button
          ...
          <div style={{
            ...
            <form onSubmit={handleEditSubmit}>
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '1rem', marginBottom: '1.5rem' }}>
                ...
                <div>
                  <label style={{ display: 'block', marginBottom: '0.5rem', fontWeight: 'bold' }}>Emergency Contact</label>
                  <input
                    type="text"
                ...
                <div>
                  <label style={{ display: 'block', marginBottom: '0.5rem', fontWeight: 'bold' }}>Emergency Phone</label>
                  <input
                    type="tel"
