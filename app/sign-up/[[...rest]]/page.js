          ...
          <div className="mt-10 space-y-3">
            ...
            <div className="flex items-start space-x-3 p-3 bg-blue-50 rounded-lg border border-blue-200">
              ...
              <div>
                ...
                <p className="text-xs text-blue-700 mt-0.5">Schedule with doctors instantly</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3 p-3 bg-green-50 rounded-lg border border-green-200">
              ...
              <div>
                ...
                <p className="text-xs text-green-700 mt-0.5">Keep all your health info in one place</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3 p-3 bg-purple-50 rounded-lg border border-purple-200">
              ...
              <div>
                <p className="text-sm font-medium text-purple-900">Secure & Encrypted</p>
                <p className="text-xs text-purple-700 mt-0.5">Your privacy is our priority</p>
              </div>
            </div>
          </div>
        </div>
